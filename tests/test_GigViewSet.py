...
class GigTests(APITestCase):
  def setUp(self):
    ...
    self.user1 = User.objects.create(first_name='first_name1', last_name='last_name1', email="test1@mail.com")
    self.user2 = User.objects.create(first_name='first_name2', last_name='last_name2', email="test2@mail.com")
